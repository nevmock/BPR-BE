...
const createKSS = JoiExtended.object({
  ...
  nik_shm: JoiExtended.string().optional().min(0),
  alamat_shm: JoiExtended.string().optional().min(0),
  ...
  tanggal_angsuran_dimulai: JoiExtended.date().format('YYYY/MM/DD').optional(),
  ...
  administrasi_persen: JoiExtended.number().optional().min(0),
  ...
  asuransi_nominal: JoiExtended.number().optional().min(0),
