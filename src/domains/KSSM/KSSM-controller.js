    ...
    async generatePDF(req, res) {
      try {
        ...
        const data = {
          ...
          nominal_materai: dbData.materai_nominal,
          nominal_asuransi_jiwa: dbData.asuransi_jiwa_nominal,
          nominal_asuransi_tlo: dbData.asuransi_tlo_nominal,
          nominal_notaris: dbData.notaris_nominal,
